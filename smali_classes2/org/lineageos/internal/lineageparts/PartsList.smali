...
.method static constructor <clinit>()V
    ...
    const-class v0, Lorg/lineageos/internal/lineageparts/PartsList;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lorg/lineageos/internal/lineageparts/PartsList;->TAG:Ljava/lang/String;
    ...
    const-string/jumbo v1, "org.lineageos.lineageparts"

    const-string/jumbo v2, "org.lineageos.lineageparts.PartsActivity"
...
.method public static get(Landroid/content/Context;)Lorg/lineageos/internal/lineageparts/PartsList;
    ...
    sget-object v1, Lorg/lineageos/internal/lineageparts/PartsList;->sInstanceLock:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lorg/lineageos/internal/lineageparts/PartsList;->sInstance:Lorg/lineageos/internal/lineageparts/PartsList;

    if-nez v0, :cond_0

    new-instance v0, Lorg/lineageos/internal/lineageparts/PartsList;

    invoke-direct {v0, p0}, Lorg/lineageos/internal/lineageparts/PartsList;-><init>(Landroid/content/Context;)V

    sput-object v0, Lorg/lineageos/internal/lineageparts/PartsList;->sInstance:Lorg/lineageos/internal/lineageparts/PartsList;
...
.method private loadParts()V
    ...
    iget-object v5, p0, Lorg/lineageos/internal/lineageparts/PartsList;->mParts:Ljava/util/Map;

    monitor-enter v5

    :try_start_0
    iget-object v4, p0, Lorg/lineageos/internal/lineageparts/PartsList;->mContext:Landroid/content/Context;
    ...
    :try_start_1
    const-string/jumbo v4, "org.lineageos.lineageparts"
    ...
    const-string/jumbo v7, "org.lineageos.lineageparts"
    ...
    iget-object v4, p0, Lorg/lineageos/internal/lineageparts/PartsList;->mParts:Ljava/util/Map;

    invoke-direct {p0, v2, v3, v4}, Lorg/lineageos/internal/lineageparts/PartsList;->loadPartsFromResourceLocked(Landroid/content/res/Resources;ILjava/util/Map;)V
    :try_end_2
...
.method private loadPartsFromResourceLocked(Landroid/content/res/Resources;ILjava/util/Map;)V
    ...
    :cond_8
    new-instance v4, Lorg/lineageos/internal/lineageparts/PartInfo;

    invoke-direct {v4, v5}, Lorg/lineageos/internal/lineageparts/PartInfo;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v12}, Lorg/lineageos/internal/lineageparts/PartInfo;->setTitle(Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v12}, Lorg/lineageos/internal/lineageparts/PartInfo;->setSummary(Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v12}, Lorg/lineageos/internal/lineageparts/PartInfo;->setFragmentClass(Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v12}, Lorg/lineageos/internal/lineageparts/PartInfo;->setIconRes(I)V

    sget-object v12, Llineageos/platform/R$styleable;->lineage_Searchable:[I
    ...
    invoke-virtual {v4, v12}, Lorg/lineageos/internal/lineageparts/PartInfo;->setXmlRes(I)V
...
.method public getPartInfo(Ljava/lang/String;)Lorg/lineageos/internal/lineageparts/PartInfo;
    ...
    iget-object v1, p0, Lorg/lineageos/internal/lineageparts/PartsList;->mParts:Ljava/util/Map;
