...
.field private mMediaStateHandler:Landroid/os/Handler;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/broadcast/BroadcastDispatcher;Ljava/util/Optional;Lcom/android/systemui/util/RingerModeTracker;)V
    ...
    iput-object p2, p0, Lcom/android/systemui/volume/VolumeDialogControllerImpl;->mMediaStateHandler:Landroid/os/Handler;
...
.method static synthetic access$2800(Lcom/android/systemui/volume/VolumeDialogControllerImpl;)Z
    ...
    .line 93
    invoke-direct {p0}, Lcom/android/systemui/volume/VolumeDialogControllerImpl;->updateLinkNotificationConfigW()Z
...
.method private synthetic lambda$updateStreamLevelW$1()V
    .locals 1

    const/4 v0, 0x0

    .line 587
    iput-boolean v0, p0, Lcom/android/systemui/volume/VolumeDialogControllerImpl;->isResumable:Z
...
.method private updateLinkNotificationConfigW()Z
    .locals 4
    ...
    iget-boolean v3, p0, Lcom/android/systemui/plugins/VolumeDialogController$State;->linkedNotification:Z
    ...
    .line 641
    :cond_1
    iput-boolean v0, p0, Lcom/android/systemui/plugins/VolumeDialogController$State;->linkedNotification:Z
...
.method private updateStreamLevelW(II)Z
    ...
    const-string v5, "adaptive_playback_enabled"
    ...
    const-string v7, "adaptive_playback_timeout"
    ...
    invoke-direct {v6, v2, v7}, Landroid/view/KeyEvent;-><init>(II)V

    invoke-virtual {v5, v6}, Landroid/media/AudioManager;->dispatchMediaKeyEvent(Landroid/view/KeyEvent;)V
    ...
    invoke-direct {v6, v3, v7}, Landroid/view/KeyEvent;-><init>(II)V

    invoke-virtual {v5, v6}, Landroid/media/AudioManager;->dispatchMediaKeyEvent(Landroid/view/KeyEvent;)V

    .line 584
    iput-boolean v3, p0, Lcom/android/systemui/volume/VolumeDialogControllerImpl;->isResumable:Z

    .line 585
    iget-object v5, p0, Lcom/android/systemui/volume/VolumeDialogControllerImpl;->mMediaStateHandler:Landroid/os/Handler;
    ...
    new-instance v6, Lcom/android/systemui/volume/-$$Lambda$VolumeDialogControllerImpl$8NZQra2D-vXwjixW_tIhtctvVjw;

    invoke-direct {v6, p0}, Lcom/android/systemui/volume/-$$Lambda$VolumeDialogControllerImpl$8NZQra2D-vXwjixW_tIhtctvVjw;-><init>(Lcom/android/systemui/volume/VolumeDialogControllerImpl;)V
    ...
    .line 591
    iget-boolean v1, p0, Lcom/android/systemui/volume/VolumeDialogControllerImpl;->isResumable:Z

    if-eqz v1, :cond_3

    .line 592
    iget-object v1, p0, Lcom/android/systemui/volume/VolumeDialogControllerImpl;->mMediaStateHandler:Landroid/os/Handler;
    ...
    .line 597
    iput-boolean v2, p0, Lcom/android/systemui/volume/VolumeDialogControllerImpl;->isResumable:Z
...
.method public synthetic lambda$updateStreamLevelW$1$VolumeDialogControllerImpl()V
    .locals 0

    invoke-direct {p0}, Lcom/android/systemui/volume/VolumeDialogControllerImpl;->lambda$updateStreamLevelW$1()V
