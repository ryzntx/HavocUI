...
.field private mDoubleTapTimeout:J
...
.field private mGoToSleep:Ljava/lang/Runnable;
...
.field private mLastDownEvent:J
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;Lcom/android/systemui/ExpandHelper$Callback;Lcom/android/systemui/statusbar/DragDownHelper$DragDownCallback;Lcom/android/systemui/plugins/FalsingManager;)V
    ...
    .line 68
    iput-wide v0, p0, Lcom/android/systemui/statusbar/DragDownHelper;->mLastDownEvent:J
    ...
    iput v1, p0, Lcom/android/systemui/statusbar/DragDownHelper;->mTouchSlop:F
    ...
    iput v0, p0, Lcom/android/systemui/statusbar/DragDownHelper;->mSlopMultiplier:F
    ...
    sget p3, Lcom/android/systemui/R$dimen;->status_bar_header_height_keyguard:I

    invoke-virtual {p2, p3}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result p2

    iput p2, p0, Lcom/android/systemui/statusbar/DragDownHelper;->mStatusBarHeaderHeight:I

    .line 86
    new-instance p2, Lcom/android/systemui/statusbar/DragDownHelper$1;

    invoke-direct {p2, p0, p1}, Lcom/android/systemui/statusbar/DragDownHelper$1;-><init>(Lcom/android/systemui/statusbar/DragDownHelper;Landroid/content/Context;)V

    iput-object p2, p0, Lcom/android/systemui/statusbar/DragDownHelper;->mGoToSleep:Ljava/lang/Runnable;
...
.method private cancelExpansion(Lcom/android/systemui/statusbar/notification/row/ExpandableView;)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/systemui/statusbar/DragDownHelper$2;-><init>(Lcom/android/systemui/statusbar/DragDownHelper;Lcom/android/systemui/statusbar/notification/row/ExpandableView;)V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 107
    iget-boolean v0, p0, Lcom/android/systemui/statusbar/DragDownHelper;->mDoubleTapToSleepEnabled:Z

    if-eqz v0, :cond_7

    iget v0, p0, Lcom/android/systemui/statusbar/DragDownHelper;->mStatusBarHeaderHeight:I
    ...
    .line 109
    iget-wide v4, p0, Lcom/android/systemui/statusbar/DragDownHelper;->mLastDownEvent:J
    ...
    .line 112
    iget-wide v4, p0, Lcom/android/systemui/statusbar/DragDownHelper;->mDoubleTapTimeout:J
    ...
    .line 113
    iget-object p1, p0, Lcom/android/systemui/statusbar/DragDownHelper;->mGoToSleep:Ljava/lang/Runnable;

    invoke-interface {p1}, Ljava/lang/Runnable;->run()V

    .line 115
    :cond_5
    iput-wide v6, p0, Lcom/android/systemui/statusbar/DragDownHelper;->mLastDownEvent:J
...
.method public updateDoubleTapToSleep(Z)V
    ...
    .line 319
    iput-boolean p1, p0, Lcom/android/systemui/statusbar/DragDownHelper;->mDoubleTapToSleepEnabled:Z
