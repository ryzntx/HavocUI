...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/broadcast/BroadcastDispatcher;Lcom/android/systemui/wm/DisplayController;Lcom/android/systemui/util/FloatingContentCoordinator;Lcom/android/systemui/util/DeviceConfigProxy;Lcom/android/systemui/pip/PipBoundsHandler;Lcom/android/systemui/pip/PipSnapAlgorithm;Lcom/android/systemui/pip/PipTaskOrganizer;Lcom/android/systemui/model/SysUiState;Lcom/android/systemui/pip/PipUiEventLogger;)V
    ...
    invoke-direct {v0, v1}, Lcom/android/systemui/pip/phone/-$$Lambda$PipManager$AYejaSf14FPjo5Gs0gXz-uHGoWo;-><init>(Lcom/android/systemui/pip/phone/PipManager;)V
    ...
    invoke-direct {v0, v1}, Lcom/android/systemui/pip/phone/PipManager$1;-><init>(Lcom/android/systemui/pip/phone/PipManager;)V
    ...
    invoke-direct {v0, v1}, Lcom/android/systemui/pip/phone/PipManager$2;-><init>(Lcom/android/systemui/pip/phone/PipManager;)V
    ...
    .line 250
    iput-object v14, v1, Lcom/android/systemui/pip/phone/PipManager;->mContext:Landroid/content/Context;
    ...
    invoke-direct {v3, v1, v4}, Lcom/android/systemui/pip/phone/PipManager$PipManagerPinnedStackListener;-><init>(Lcom/android/systemui/pip/phone/PipManager;Lcom/android/systemui/pip/phone/PipManager$1;)V
    ...
    .line 263
    invoke-virtual {v2, v1}, Lcom/android/systemui/pip/PipTaskOrganizer;->registerPipTransitionCallback(Lcom/android/systemui/pip/PipTaskOrganizer$PipTransitionCallback;)V
    ...
    invoke-direct {v0, v14, v2, v3}, Lcom/android/systemui/pip/phone/PipMediaController;-><init>(Landroid/content/Context;Landroid/app/IActivityManager;Lcom/android/systemui/broadcast/BroadcastDispatcher;)V
    ...
    invoke-direct {v5, v14, v0, v2}, Lcom/android/systemui/pip/phone/PipMenuActivityController;-><init>(Landroid/content/Context;Lcom/android/systemui/pip/phone/PipMediaController;Lcom/android/systemui/shared/system/InputConsumerController;)V
    ...
    invoke-direct {v0, v14, v2, v3}, Lcom/android/systemui/pip/phone/PipAppOpsListener;-><init>(Landroid/content/Context;Landroid/app/IActivityManager;Lcom/android/systemui/pip/phone/PipAppOpsListener$Callback;)V
    ...
    invoke-virtual {v15, v0}, Lcom/android/systemui/wm/DisplayController;->addDisplayChangingController(Lcom/android/systemui/wm/DisplayChangeController$OnDisplayChangingListener;)V
    ...
    invoke-virtual {v15, v0}, Lcom/android/systemui/wm/DisplayController;->addDisplayWindowListener(Lcom/android/systemui/wm/DisplayController$OnDisplaysChangedListener;)V
...
.method public onPipTransitionStarted(Landroid/content/ComponentName;I)V
    ...
    .line 365
    invoke-virtual {p0}, Lcom/android/systemui/pip/phone/PipManager;->updateReentryBounds()V
...
.method public updateReentryBounds()V
    .locals 3

    .line 383
    iget-object v0, p0, Lcom/android/systemui/pip/phone/PipManager;->mTouchHandler:Lcom/android/systemui/pip/phone/PipTouchHandler;

    invoke-virtual {v0}, Lcom/android/systemui/pip/phone/PipTouchHandler;->getUserResizeBounds()Landroid/graphics/Rect;

    move-result-object v0

    .line 385
    iget-object v1, p0, Lcom/android/systemui/pip/phone/PipManager;->mPipTaskOrganizer:Lcom/android/systemui/pip/PipTaskOrganizer;
    ...
    .line 386
    iget-object v2, p0, Lcom/android/systemui/pip/phone/PipManager;->mPipBoundsHandler:Lcom/android/systemui/pip/PipBoundsHandler;

    invoke-virtual {v2, v1}, Lcom/android/systemui/pip/PipBoundsHandler;->getSnapFraction(Landroid/graphics/Rect;)F
    ...
    invoke-virtual {v2, v0, v1}, Lcom/android/systemui/pip/PipBoundsHandler;->applySnapFraction(Landroid/graphics/Rect;F)V

    .line 388
    iget-object p0, p0, Lcom/android/systemui/pip/phone/PipManager;->mReentryBounds:Landroid/graphics/Rect;
