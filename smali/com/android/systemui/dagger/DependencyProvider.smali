...
.method public providePulseController(Landroid/content/Context;Landroid/os/Handler;Ljava/util/concurrent/Executor;)Lcom/android/systemui/statusbar/policy/PulseController;
    .locals 0

    .line 259
    new-instance p0, Lcom/android/systemui/navigation/pulse/PulseControllerImpl;

    invoke-direct {p0, p1, p2, p3}, Lcom/android/systemui/navigation/pulse/PulseControllerImpl;-><init>(Landroid/content/Context;Landroid/os/Handler;Ljava/util/concurrent/Executor;)V
...
.method public provideTaskHelper(Landroid/content/Context;)Lcom/android/systemui/statusbar/policy/TaskHelper;
    .locals 0

    .line 253
    new-instance p0, Lcom/android/systemui/statusbar/policy/TaskHelper;

    invoke-direct {p0, p1}, Lcom/android/systemui/statusbar/policy/TaskHelper;-><init>(Landroid/content/Context;)V
