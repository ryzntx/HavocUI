...
.method public isFalseTouch(I)Z
    ...
    .line 266
    sget-boolean p1, Lcom/android/systemui/classifier/FalsingLog;->ENABLED:Z

    if-eqz p1, :cond_0

    .line 269
    iget-boolean p1, p0, Lcom/android/systemui/classifier/FalsingManagerImpl;->mSessionActive:Z
    ...
    iget-object p1, p0, Lcom/android/systemui/classifier/FalsingManagerImpl;->mPendingWtf:Ljava/lang/Runnable;
    ...
    .line 272
    iget-boolean v3, p0, Lcom/android/systemui/classifier/FalsingManagerImpl;->mScreenOn:Z

    .line 273
    iget p1, p0, Lcom/android/systemui/classifier/FalsingManagerImpl;->mState:I
    ...
    const-string v0, "Session is not active, yet there\'s a query for a false touch."
    ...
    const-string v0, ". Escalating to WTF if screen does not turn on soon."
    ...
    .line 275
    invoke-static {v0, p1}, Lcom/android/systemui/classifier/FalsingLog;->wLogcat(Ljava/lang/String;Ljava/lang/String;)V

    .line 287
    new-instance p1, Lcom/android/systemui/classifier/-$$Lambda$FalsingManagerImpl$v5ZF-PRlWWHHEjWpilJxodWNKMI;

    move-object v0, p1

    move-object v1, p0

    invoke-direct/range {v0 .. v5}, Lcom/android/systemui/classifier/-$$Lambda$FalsingManagerImpl$v5ZF-PRlWWHHEjWpilJxodWNKMI;-><init>(Lcom/android/systemui/classifier/FalsingManagerImpl;IILjava/lang/String;Ljava/lang/Throwable;)V

    iput-object p1, p0, Lcom/android/systemui/classifier/FalsingManagerImpl;->mPendingWtf:Ljava/lang/Runnable;
    ...
    .line 304
    :cond_1
    iget-object p1, p0, Lcom/android/systemui/classifier/FalsingManagerImpl;->mAccessibilityManager:Landroid/view/accessibility/AccessibilityManager;
    ...
    .line 309
    :cond_2
    iget-boolean p1, p0, Lcom/android/systemui/classifier/FalsingManagerImpl;->mIsTouchScreen:Z
    ...
    .line 314
    :cond_3
    iget-boolean p1, p0, Lcom/android/systemui/classifier/FalsingManagerImpl;->mJustUnlockedWithFace:Z
    ...
    .line 319
    :cond_4
    iget p1, p0, Lcom/android/systemui/classifier/FalsingManagerImpl;->mIsFalseTouchCalls:I
    ...
    .line 320
    iget-object p1, p0, Lcom/android/systemui/classifier/FalsingManagerImpl;->mHumanInteractionClassifier:Lcom/android/systemui/classifier/HumanInteractionClassifier;

    invoke-virtual {p1}, Lcom/android/systemui/classifier/HumanInteractionClassifier;->isFalseTouch()Z
    ...
    const-string v2, "Calls before success: "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v2, p0, Lcom/android/systemui/classifier/FalsingManagerImpl;->mIsFalseTouchCalls:I
    ...
    const-string v2, "isFalseTouchCalls"

    invoke-static {v2, v1}, Lcom/android/systemui/classifier/FalsingLog;->i(Ljava/lang/String;Ljava/lang/String;)V

    .line 325
    :cond_5
    iget-object v1, p0, Lcom/android/systemui/classifier/FalsingManagerImpl;->mMetricsLogger:Lcom/android/internal/logging/MetricsLogger;

    iget v2, p0, Lcom/android/systemui/classifier/FalsingManagerImpl;->mIsFalseTouchCalls:I

    const-string v3, "falsing_success_after_attempts"

    invoke-virtual {v1, v3, v2}, Lcom/android/internal/logging/MetricsLogger;->histogram(Ljava/lang/String;I)V
