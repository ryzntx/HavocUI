...
.method public static final synthetic access$getCustomAnimationHandler$p(Lcom/android/systemui/util/animation/PhysicsAnimator;)Landroidx/dynamicanimation/animation/AnimationHandler;
    .locals 0

    .line 92
    iget-object p0, p0, Lcom/android/systemui/util/animation/PhysicsAnimator;->customAnimationHandler:Landroidx/dynamicanimation/animation/AnimationHandler;
...
.method public final setCustomAnimationHandler(Landroidx/dynamicanimation/animation/AnimationHandler;)V
    .locals 1
    .param p1    # Landroidx/dynamicanimation/animation/AnimationHandler;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    ...
    .line 462
    iput-object p1, p0, Lcom/android/systemui/util/animation/PhysicsAnimator;->customAnimationHandler:Landroidx/dynamicanimation/animation/AnimationHandler;
...
.method public final startInternal$frameworks__base__packages__SystemUI__android_common__SystemUI_core()V
    ...
    .line 541
    iget-object v4, p0, Lcom/android/systemui/util/animation/PhysicsAnimator;->customAnimationHandler:Landroidx/dynamicanimation/animation/AnimationHandler;

    if-eqz v4, :cond_6

    invoke-virtual {v3}, Landroidx/dynamicanimation/animation/DynamicAnimation;->getAnimationHandler()Landroidx/dynamicanimation/animation/AnimationHandler;

    move-result-object v4

    iget-object v5, p0, Lcom/android/systemui/util/animation/PhysicsAnimator;->customAnimationHandler:Landroidx/dynamicanimation/animation/AnimationHandler;
    ...
    new-array v4, v5, [Landroidx/dynamicanimation/animation/FloatPropertyCompat;

    aput-object v11, v4, v2

    .line 544
    invoke-virtual {p0, v4}, Lcom/android/systemui/util/animation/PhysicsAnimator;->cancel([Landroidx/dynamicanimation/animation/FloatPropertyCompat;)V

    .line 548
    :cond_4
    iget-object v2, p0, Lcom/android/systemui/util/animation/PhysicsAnimator;->customAnimationHandler:Landroidx/dynamicanimation/animation/AnimationHandler;
    ...
    :goto_1
    invoke-virtual {v3, v2}, Landroidx/dynamicanimation/animation/DynamicAnimation;->setAnimationHandler(Landroidx/dynamicanimation/animation/AnimationHandler;)V

    .line 552
    :cond_6
    invoke-virtual {v14, v3}, Lcom/android/systemui/util/animation/PhysicsAnimator$SpringConfig;->applyToAnimation$frameworks__base__packages__SystemUI__android_common__SystemUI_core(Landroidx/dynamicanimation/animation/SpringAnimation;)V

    .line 553
    new-instance v2, Lcom/android/systemui/util/animation/PhysicsAnimator$startInternal$2;

    invoke-direct {v2, v3}, Lcom/android/systemui/util/animation/PhysicsAnimator$startInternal$2;-><init>(Landroidx/dynamicanimation/animation/SpringAnimation;)V
    ...
    .line 561
    iget-object v3, p0, Lcom/android/systemui/util/animation/PhysicsAnimator;->endListeners:Ljava/util/ArrayList;
