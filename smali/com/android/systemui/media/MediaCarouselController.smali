...
.method public constructor <init>(Landroid/content/Context;Ljavax/inject/Provider;Lcom/android/systemui/statusbar/notification/VisualStabilityManager;Lcom/android/systemui/media/MediaHostStatesManager;Lcom/android/systemui/plugins/ActivityStarter;Lcom/android/systemui/util/concurrency/DelayableExecutor;Lcom/android/systemui/media/MediaDataManager;Lcom/android/systemui/statusbar/policy/ConfigurationController;Lcom/android/systemui/plugins/FalsingManager;)V
    ...
    .param p6    # Lcom/android/systemui/util/concurrency/DelayableExecutor;
        ...
        .end annotation
    .end param
    .param p7    # Lcom/android/systemui/media/MediaDataManager;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    ...
    iput-object v1, v0, Lcom/android/systemui/media/MediaCarouselController;->keysNeedRemoval:Ljava/util/Set;
    ...
    invoke-direct {v13, v3}, Lcom/android/systemui/media/MediaCarouselController$1;-><init>(Lcom/android/systemui/media/MediaDataManager;)V
    ...
    .line 155
    new-instance v3, Lcom/android/systemui/media/MediaCarouselController$3;

    invoke-direct {v3, v0}, Lcom/android/systemui/media/MediaCarouselController$3;-><init>(Lcom/android/systemui/media/MediaCarouselController;)V
    ...
    .line 153
    invoke-direct/range {v9 .. v16}, Lcom/android/systemui/media/MediaCarouselScrollHandler;-><init>(Lcom/android/systemui/media/MediaScrollView;Lcom/android/systemui/qs/PageIndicator;Lcom/android/systemui/util/concurrency/DelayableExecutor;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;Lcom/android/systemui/plugins/FalsingManager;)V
    ...
    .line 160
    new-instance v2, Lcom/android/systemui/media/MediaCarouselController$4;

    invoke-direct {v2, v0}, Lcom/android/systemui/media/MediaCarouselController$4;-><init>(Lcom/android/systemui/media/MediaCarouselController;)V
    ...
    .line 174
    iget-object v1, v0, Lcom/android/systemui/media/MediaCarouselController;->mediaManager:Lcom/android/systemui/media/MediaDataManager;
    ...
    invoke-virtual {v1, v2}, Lcom/android/systemui/media/MediaDataManager;->addListener(Lcom/android/systemui/media/MediaDataManager$Listener;)V
    ...
    new-instance v2, Lcom/android/systemui/media/MediaCarouselController$7;

    invoke-direct {v2, v0}, Lcom/android/systemui/media/MediaCarouselController$7;-><init>(Lcom/android/systemui/media/MediaCarouselController;)V
...
.method public static final synthetic access$getVisualStabilityManager$p(Lcom/android/systemui/media/MediaCarouselController;)Lcom/android/systemui/statusbar/notification/VisualStabilityManager;
    .locals 0

    .line 39
    iget-object p0, p0, Lcom/android/systemui/media/MediaCarouselController;->visualStabilityManager:Lcom/android/systemui/statusbar/notification/VisualStabilityManager;
...
.method private final addOrUpdatePlayer(Ljava/lang/String;Ljava/lang/String;Lcom/android/systemui/media/MediaData;)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/systemui/media/MediaPlayerData;->getMediaPlayer(Ljava/lang/String;Ljava/lang/String;)Lcom/android/systemui/media/MediaControlPanel;
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/systemui/media/PlayerViewHolder$Companion;->create(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;)Lcom/android/systemui/media/PlayerViewHolder;

    move-result-object v1

    invoke-virtual {p2, v1}, Lcom/android/systemui/media/MediaControlPanel;->attach(Lcom/android/systemui/media/PlayerViewHolder;)V
    ...
    new-instance v2, Lcom/android/systemui/media/MediaCarouselController$addOrUpdatePlayer$1;

    invoke-direct {v2, p0}, Lcom/android/systemui/media/MediaCarouselController$addOrUpdatePlayer$1;-><init>(Lcom/android/systemui/media/MediaCarouselController;)V
    ...
    .line 253
    :cond_0
    invoke-virtual {p2, p3, p1}, Lcom/android/systemui/media/MediaControlPanel;->bind(Lcom/android/systemui/media/MediaData;Ljava/lang/String;)V

    .line 254
    iget-boolean v1, p0, Lcom/android/systemui/media/MediaCarouselController;->currentlyExpanded:Z

    invoke-virtual {p2, v1}, Lcom/android/systemui/media/MediaControlPanel;->setListening(Z)V

    .line 255
    sget-object v1, Lcom/android/systemui/media/MediaPlayerData;->INSTANCE:Lcom/android/systemui/media/MediaPlayerData;

    invoke-virtual {v1, p1, p3, p2}, Lcom/android/systemui/media/MediaPlayerData;->addMediaPlayer(Ljava/lang/String;Lcom/android/systemui/media/MediaData;Lcom/android/systemui/media/MediaControlPanel;)V

    .line 256
    invoke-direct {p0, p2, v0}, Lcom/android/systemui/media/MediaCarouselController;->updatePlayerToState(Lcom/android/systemui/media/MediaControlPanel;Z)V
    ...
    invoke-static {p1, v0}, Lcom/android/systemui/util/animation/UniqueObjectHostViewKt;->setRequiresRemeasuring(Landroid/view/View;Z)V
    ...
    const-string p0, "MediaCarouselController"
